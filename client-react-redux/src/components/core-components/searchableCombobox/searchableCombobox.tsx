...
const SearchableCombobox: React.FC<SearchableComboBoxProps> = ({ items, onSelect, label, required }) => {
            ...
            {isOpen && (
                ...
                >
                    {filteredItems.map((item, index) => (
                        <li
                            key={item}
                            className={`px-4 py-2 text-xs cursor-pointer ${index === highlightedIndex ? 'bg-blue-500 text-white' : 'hover:bg-gray-200'
                                }`}
